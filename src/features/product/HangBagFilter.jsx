// features/product/HandbagFilterSidebar.jsx
"use client";
...
// Price Range Filter Component (Same as watch component)
const PriceRangeFilter = ({ activeFilters, toggleFilter }) => {
  ...
  const handlePriceRangeChange = (field, value) => {
    ...
    if (field === 'min') {
      newRange = { 
        ...currentRange, 
        min: Math.min(numValue, currentRange.max - 100) // Ensure min doesn't exceed max
      };
    } else {
      newRange = { 
        ...currentRange, 
        max: Math.max(numValue, currentRange.min + 100) // Ensure max doesn't go below min
      };
    }
...
const AdvancedFiltersModal = ({ 
  ...
  // Advanced filters data for handbags
    ...
    },
    {
      ...
      options: subCategories.length > 0 
        ...
        : [
            ...
            { value: "Hobo Bag", label: "Hobo Bag" },
            { value: "Satchel", label: "Satchel" },
            { value: "Bucket Bag", label: "Bucket Bag" },
            { value: "Messenger Bag", label: "Messenger Bag" },
...
const HandbagFilterSidebar = ({ 
  ...
  const getColorHex = (color) => {
    const colorMap = {
      ...
      'Chrome': '#E5E7EB',
      'Gunmetal': '#2C2C2C',
      'black/brown': 'linear-gradient(45deg, #000000 50%, #8B4513 50%)'
    };
  ...
  // Debug logs
  useEffect(() => {
    console.log('HandbagFilterSidebar - Active Filters:', activeFilters);
    console.log('HandbagFilterSidebar - Price Range:', activeFilters?.priceRange);
  }, [activeFilters]);
...
export default HandbagFilterSidebar;