...
const PaymentCancel = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-100 py-4 px-3 sm:px-4 lg:px-8">
      <div className="max-w-md mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl">
          ...
          <div className="bg-gradient-to-r from-orange-500 to-red-600 p-6 sm:p-8 text-center relative">
            ...
            <h1 className="text-xl sm:text-2xl font-bold text-white mb-2">Payment Cancelled</h1>
            <p className="text-orange-100 text-xs sm:text-sm">Your transaction was not completed</p>
          </div>
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-6">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                  ...
                  <span className="font-semibold text-gray-900">#{orderDetails._id.slice(-8)}</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
        ...
        <div className="mt-4 sm:mt-6 grid gap-3 sm:gap-4">
          ...
          <div className="bg-white rounded-lg p-3 sm:p-4 shadow-sm">
            <h3 className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">Tips for Successful Payment</h3>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 sm:p-4">
            <h3 className="font-semibold text-blue-900 mb-2 text-sm sm:text-base">Still Need Help?</h3>
