...
const ProductDetailPage = () => {
  ...
  // Improved Breadcrumb navigation with brand support
      ...
      if (product.productType) {
        crumbs.push({
          ...
          path: `/category/${product.category
            ...
            .replace(/\s+/g, "-")}/${product.subCategory
            ?.toLowerCase()
            .replace(/\s+/g, "-")}/${product.productType
            .toLowerCase()
            .replace(/\s+/g, "-")}`,
          type: "type",
        });
  ...
  const handleSocialShare = (platform) => {
    ...
    const productTitle = encodeURIComponent(product?.name || "Premium Product");
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <span className="text-red-500 font-bold text-sm">
                      ...
                      {getCurrencySymbol()}
                      {convertPrice(product.salePrice || product.sellingPrice)}
                    </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 p-3 sm:p-4 md:p-6">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              {(showRestockInput || product.stockQuantity === 0) &&
                !isSubscribed && <RestockNotification />}
...
// Add custom CSS for animations and responsive styles with hover zoom styles
const style = `
  @keyframes slide-up {
    from {
