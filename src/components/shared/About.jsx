...
export default function About() {
  const services = [
    {
      ...
      icon: <Gem className="w-8 h-8 sm:w-10 sm:h-10" />
    },
    { 
  ...
  const disclaimerText = "We are not an authorized dealer of any of the brands listed on this website. All stock is sourced from the open market and private collections.";
    ...
    <main className="min-h-screen bg-white text-gray-800 overflow-x-hidden">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 -z-10">
          ...
          {/* Optimized Image with sizes prop */}
          <div className="absolute inset-0">
            <Image
              src={AboutHero}
              alt="Montres Luxury Watches Collection"
              fill
        ...
        <div className="absolute inset-0 overflow-hidden opacity-10">
          <div className="absolute -top-24 -right-24 w-96 h-96 bg-gold rounded-full mix-blend-overlay filter blur-xl"></div>
        </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              {[
                ...
                <div key={index} className="flex items-start gap-3 sm:gap-4 p-3 sm:p-4 rounded-xl hover:bg-gray-50 transition-colors">
                  <span className="flex-shrink-0 text-gold">{feature.icon}</span>
                  <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="relative">
              <div className="overflow-x-auto snap-x snap-mandatory scrollbar-hide flex gap-4 pb-6 -mx-4 px-4">
                {services.map((service, index) => (
                  ...
                  >
                    <div className="text-gold mb-3 sm:mb-4">{service.icon}</div>
          ...
          <div className="hidden lg:grid grid-cols-2 xl:grid-cols-4 gap-6 lg:gap-8">
            {services.map((service, index) => (
              ...
              >
                <div className="text-gold mb-4 lg:mb-6 transform group-hover:scale-110 transition-transform duration-300">
                  {service.icon}
                </div>
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 text-center">
            {[
              { number: "1,200+", label: "Happy Customers", icon: <Users className="w-8 h-8 mx-auto mb-4 text-gold" /> },
              { number: "15+", label: "Years Experience", icon: <Clock className="w-8 h-8 mx-auto mb-4 text-gold" /> },
              { number: "500+", label: "Watches Serviced", icon: <Settings className="w-8 h-8 mx-auto mb-4 text-gold" /> },
            ].map((stat, index) => (
